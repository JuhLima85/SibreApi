package br.com.sibre.nova.api.Utils;
...
@Service
public class Formulario_Report {
    public boolean creatPdf(List<Membro> cad, ServletContext context, HttpServletRequest request,
        ...
        try {
            ...
            for (Membro cadastro : cad) {
                ...
                PdfPCell enderValue = new PdfPCell(new Paragraph(cadastro.getEndereco(), tableBody));
                ...
                PdfPCell foneValue = new PdfPCell(new Paragraph(cadastro.getTelefone(), tableBody));
                ...
                PdfPCell dataNascValue = new PdfPCell(new Paragraph(cadastro.getDataNascimento(), tableBody));
                ...
                PdfPCell membroValue = new PdfPCell(new Paragraph(String.valueOf(cadastro.isMembro()), tableBody));
            ...
            Logger.getLogger(MembroServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public boolean createExcel(List<Membro> cad, ServletContext context, HttpServletRequest request,
